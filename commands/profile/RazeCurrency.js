...
exports.exec = async (Bastion, message, args) => {
  ...
  let description = message.author.id === args.id ? `**${args.tag}** you currently have **${bastionCurrencies}** Raze  in your account.` : `**${args.tag}** currently has **${bastionCurrencies}** raze in their account.`;

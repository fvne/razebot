    ...
    if (message.content.toLowerCase().startsWith('help')) {
      return message.channel.send({
        embed: {
          color: message.client.colors.BLUE,
          title: 'The Raze Bot',
          url: 'https://google.com/lol',
          description: 'server will be created soon',
          fields: [
            {
              name: 'Bastion HQ Invite Link',
              value: 'google.com/soon'
            },
            {
              name: 'Raze Bot Invite Link',
              value: `https://discord.com/api/oauth2/authorize?client_id=708584425860104273&permissions=8&scope=bot`
            }
          ],
          thumbnail: {
